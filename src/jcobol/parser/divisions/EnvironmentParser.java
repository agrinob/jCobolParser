...
public class EnvironmentParser {
    ...
    public EnvironmentParser(final TokenList tokens) {
        this.tokens = tokens;
    }

    public EnvironmentDivision.env_division_return parse() throws RecognitionException, IOException {
        ...
        List<AntlrCobolToken> list  = fact.getTokens(tokens, "ENVIRONMENT");
        CobolTokenStream cb         = new CobolTokenStream(list);

        EnvironmentDivision envdiv = new EnvironmentDivision(cb);
        return envdiv.env_division();
    }
}
