...
public class IdParserTest {
    ...
    private final String nonStandarEntry =
      "000100 IDENTIFICATION DIVISION.\n"+
      "000200 PROGRAM-ID.\n"+
      "000300     SM206A.\n"+
      "000300 AUTHOR.   John Doe.\n"+
      ...
      "000300 DATE-COMPILED.\n"+
      "000400****************************************************************\n"+
      "000500 NONSTANDARD.    This must fail.";
...
//            assertEquals(expResult, result);
    ...
    @Test
    public void testParseNonStandardEntry() throws Exception {
        System.out.println("parse non-standard entry");
        StringReader program = new StringReader(nonStandarEntry);
        CobolLexer lexer = new CobolLexer(program);
        try {
            TokenList tokens = lexer.getTokens();
            IdParser instance = new IdParser(tokens);
